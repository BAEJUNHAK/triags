        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter:
                ...
                if iteration > opt.densify_from_iter and iteration % opt.densification_interval == 0:
                    # With background-removed images, use low opacity threshold (0.005):
                    # - opacity_reset sets all to 0.01, which is > 0.005 → safe
                    # - Only prune Gaussians that fail to recover after reset
